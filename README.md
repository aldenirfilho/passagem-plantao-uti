...
7. Revise cada linha, corrija eventuais interpretações e confirme o checklist.
8. Copie ou imprima a passagem.
...
- `index.html`, `styles.css`, `app.js`: interface responsiva e persistência local.
